 ...
 * @author kevin
 */
public class PrincipalX extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingresa un Pais:");
        ...
        bodyLayout.setHorizontalGroup(
            ...
            .addGroup(bodyLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(textPais, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        ...
        textPais.getAccessibleContext().setAccessibleName("");
        textPais.getAccessibleContext().setAccessibleDescription("");
    ...
    private void siguienteBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteBTNActionPerformed
        ...
        Crud c = new Crud();
        //Falta leer el pais y luego mandarle a imprimir el resto de info: 
        ...
        try {
            c.obtenerHabitaciones(pais).forEach(x -> model.addRow(new Object[]{x.getIdHabitacion(), x.getNombreHotel(), x.getTipoHabitacion(), x.getPrecioNoche(), x.getPais()}));
